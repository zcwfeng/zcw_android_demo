...
public class MainPage1Fragment extends Fragment {
    ...
    public static MainPage1Fragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.fragment1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.fragment1_2);
            }
        });
    }
}