...
public class MainPage2Fragment extends Fragment {
    ...
    public static MainPage2Fragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.fragment2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.fragment2_3);
            }
        });
    }
}