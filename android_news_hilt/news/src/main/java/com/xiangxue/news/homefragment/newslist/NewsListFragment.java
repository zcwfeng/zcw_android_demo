...
//                .get(getArguments().getString(BUNDLE_KEY_PARAM_CHANNEL_ID), NewsListViewModel.class);
        return new ViewModelProvider(getActivity(),
                new SavedStateViewModelFactory(getActivity().getApplication(),getActivity(),getArguments()))
                .get(getArguments().getString(BUNDLE_KEY_PARAM_CHANNEL_NAME), NewsListViewModel.class);
    }
