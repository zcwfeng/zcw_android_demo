package top.zcwfeng.permission_aop.aspect;
...
import top.zcwfeng.permission_aop.IPermission;
...
public class PermissionAspect {
    ...
    // 仅仅是只能找到这个函数
    @Pointcut
("execution(@top.zcwfeng.permission_aop.annotation.Permission * *(..)) && @annotation(permission)") //  @Permission == permission
