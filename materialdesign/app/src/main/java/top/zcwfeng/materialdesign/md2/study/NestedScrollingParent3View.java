package top.zcwfeng.materialdesign.md2.study;
...
public class NestedScrollingParent3View extends LinearLayout implements NestedScrollingParent3 {

    private NestedScrollingParentHelper mNestedScrollingParentHelper = new NestedScrollingParentHelper(this);

    public NestedScrollingParent3View(Context context) {
        super(context);
    }
     ...
     * @param consumed [输出参数]这个参数要我们在实现这个函数的时候指定，回头告诉子View当前父View消耗的距离
