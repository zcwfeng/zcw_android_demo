...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
         ...
         *
         * <p>The read timeout is applied to both the TCP socket and for individual read IO
         * operations
        ...
        /**
         * Sets the interval between HTTP/2 and web socket pings initiated by this client. Use
         * this to
         * automatically send ping frames until either the connection fails or it is closed. This
         * keeps
         ...
         * connection is canceled and its listener is {@linkplain WebSocketListener#onFailure
         * notified
        ...
        public Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            this.certificateChainCleaner =
                    Platform.get().buildCertificateChainCleaner(sslSocketFactory);
            return this;
        }
         ...
         * href="http://tools.ietf.org/html/draft-ietf-tls-applayerprotoneg">ALPN</a> will be
         * used to
         * negotiate a transport.
         *
         * <p>{@link Protocol#HTTP_1_0} is not supported in this set. Requests are initiated with
         * {@code
         * HTTP/1.1} only. If the server responds with {@code HTTP/1.0}, that will be exposed by
         * {@link
         * Response#protocol()}.
         *
