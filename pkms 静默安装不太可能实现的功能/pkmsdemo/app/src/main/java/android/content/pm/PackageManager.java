...
public abstract class PackageManager {
    ...
    */
    ...
    Intent getLaunchIntentForPackage(@NonNull String packageName);
    ...
    public abstract ApplicationInfo getApplicationInfoAsUser(String packageName,
            @ApplicationInfoFlags int flags, int userId) throws NameNotFoundException;
...
//        }
    ...
    public abstract List<ApplicationInfo> getInstalledApplicationsAsUser(
            @ApplicationInfoFlags int flags,  int userId);
     ...
     */
    @SystemApi
    public abstract @NonNull List<Object> getInstantApps();
    ...
    public abstract @NonNull List<SharedLibraryInfo> getSharedLibrariesAsUser(
            @InstallFlags int flags,  int userId);
    ...
    public List<ResolveInfo> queryBroadcastReceiversAsUser(Intent intent,
        ...
        return queryBroadcastReceiversAsUser(intent, flags, 0);
    }
...
//        }
     ...
     */
    @SystemApi
    public abstract List<Object> getIntentFilterVerifications(
            String packageName);
    ...
    public abstract void deletePackageAsUser(@NonNull String packageName,
            IPackageDeleteObserver observer, @DeleteFlags int flags,  int userId);
     ...
     * @hide
     */
    public void freeStorageAndNotify(long freeStorageSize, Object observer) {
     ...
     */
    @Deprecated
    public void getPackageSizeInfo(String packageName, Object observer) {
        getPackageSizeInfoAsUser(packageName, 0, null);
    }
     ...
     *
     * @see {@link Settings.Secure#ANDROID_ID}
     * @hide
     */
