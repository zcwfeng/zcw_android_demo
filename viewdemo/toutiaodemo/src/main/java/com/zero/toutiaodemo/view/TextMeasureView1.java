...
public class TextMeasureView1 extends AppCompatTextView {
    ...
    public TextMeasureView1(final Context context) {
        super(context);
        init();
    }

    public TextMeasureView1(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextMeasureView1(final Context context, final AttributeSet attrs, final int defStyleAttr) {
